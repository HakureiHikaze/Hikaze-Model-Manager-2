...
- [ ] Task: Update `conductor/product.md` with verified core features and vision
- [ ] Task: Update `conductor/product-guidelines.md` with verified UX and interaction rules
- [ ] Task: Verify updated product docs reflect implementation state (including "Not Implemented" markers)
...
- [ ] Task: Audit `.codex/constitution/tech-stack.md` and `.codex/skills/` against current dependencies and architecture
- [ ] Task: Update `conductor/tech-stack.md` with verified frontend and backend stacks
- [ ] Task: Update `conductor/code_styleguides/` if needed based on `.codex` findings
